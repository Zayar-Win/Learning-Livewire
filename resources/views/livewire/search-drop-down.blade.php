<div class="flex-1 flex items-center mt-5 justify-center px-2 lg:ml-6 lg:justify-end">
    <div class="max-w-lg w-full lg:max-w-xs">
        ...
        <div class="relative">
            ...
            <ul
                ...
                <li>
                    <a @if (array_key_exists('trackViewUrl', $result)) href="{{ $result['trackViewUrl'] }}" @else
                        href="#" @endif
